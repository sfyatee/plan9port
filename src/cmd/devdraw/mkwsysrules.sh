...
if [ $WSYSTYPE = x11 ]; then
	...
	echo 'WSYSOFILES=$WSYSOFILES xdg-decoration-protocol.o xdg-shell-protocol.o wp-pointer-warp.o wl-util.o wl-cb.o wl-draw.o wl-screen.o'
	echo 'WSYSHFILES=xdg-shell-protocol.h xdg-decoration-protocol.h wp-pointer-warp.h wl-inc.h'
